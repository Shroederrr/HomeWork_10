...
const lightboxPrevButton = lightboxModal.querySelector(
  ".lightboxModal__arrow_prev"
);
const lightboxNextButton = lightboxModal.querySelector(
  ".lightboxModal__arrow_next"
);
...
// Функція для відображення фотографії
...
// Відкриття при кліку на фотографію
...
// Обробка кліків на кнопках "Попередня" і "Наступна"
...
// Відображення першої фотографії
